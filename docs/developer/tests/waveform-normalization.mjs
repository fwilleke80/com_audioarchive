...
let normalization = await readFile(new URL('normalization.js', base), 'utf8');
...
normalization = normalization.replace('./audio-session.js?v=0.13.2.7', 'data:text/javascript;base64,' + Buffer.from(sessionSource).toString('base64'));
