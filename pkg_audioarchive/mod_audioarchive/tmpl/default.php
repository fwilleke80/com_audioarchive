						...
						echo LayoutHelper::render(
							...
							[
								...
								'labels' => [
									...
									'varispeed' => Text::_('MOD_AUDIOARCHIVE_PLAYER_VARISPEED'),
									'varispeedReset' => Text::_('MOD_AUDIOARCHIVE_PLAYER_VARISPEED_RESET'),
									'varispeedNormal' => Text::_('MOD_AUDIOARCHIVE_PLAYER_VARISPEED_NORMAL'),
									'varispeedOctave' => Text::_('MOD_AUDIOARCHIVE_PLAYER_VARISPEED_OCTAVE_ABBR'),
								],
							],
							null,
							[
