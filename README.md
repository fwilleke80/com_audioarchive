...
- Browser-local polyphonic Sound Boards with MIDI/onscreen chromatic sampler mode
...
1. Download the versioned installer ZIP, for example `pkg_audioarchive_v0-11-20.zip`.
